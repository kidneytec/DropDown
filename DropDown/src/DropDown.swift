...
private extension DropDown {
    ...
    func setup() {
        ...
        heightObservation = tableView.observe(\.contentSize, changeHandler: { [weak self] _, _ in
...
extension DropDown {
    ...
    fileprivate var tableHeight: CGFloat {
        return tableView.contentSize.height // tableView.rowHeight * CGFloat(dataSource.count)
    }
